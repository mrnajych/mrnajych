## Hi there, I am Mritunjay Natani...,
...
| [![Password Generator](https://cdn-icons-png.flaticon.com/512/3256/3256783.png)](https://github.com/mrnajych/Password_Generator)|HTML, CSS, Tailwind, Node.js, Javascript | The Secure Password Generator project utilizes the Math.random library to create passwords of varying strengths,  including uppercase letters, lowercase letters, numbers, and symbols. Built with HTML, CSS, JavaScript, Tailwind CSS, and Node.js, it features a convenient copy-to-clipboard button, enhancing user experience by making secure password generation both intuitive and efficient. | A web application that enables users to create strong, randomized passwords with customizable lengths and character options, including uppercase letters, lowercase letters, numbers, and symbols, using the Math.random library. Developed with HTML, CSS, JavaScript, Tailwind CSS, and Node.js|
